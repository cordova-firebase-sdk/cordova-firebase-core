...
export declare class BaseClass {
     ...
     */
    _on(eventName: string, listener: (...parameters: Array<any>) => void): void;
    /**
     ...
     */
    _off(eventName?: string, listener?: (...parameters: Array<any>) => void): Array<(...parameters: Array<any>) => void>;
    /**
     ...
     * @param listener - event listener
     */
    _one(eventName: string, listener: (...parameters: Array<any>) => void): void;
}
