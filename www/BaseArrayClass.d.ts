...
export declare class BaseArrayClass extends BaseClass {
     ...
     */
    _mapSeries(iteratee: (item: any, idx: number, next: (result: any) => void) => void): Promise<any[]>;
    /**
     ...
     * @returns a promise with transformed values
     */
    _mapAsync(iteratee: (item: any, idx: number, next: (result: any) => void) => void): Promise<any[]>;
    /**
     ...
     */
    _map(iteratee: (item: any) => any): any[];
    /**
     ...
     */
    _filterAsync(iteratee: (item: any, idx: number, next: (result: boolean) => void) => void): Promise<any[]>;
    /**
     ...
     */
    _filter(iteratee: (item: any, idx: number) => boolean): any[];
    /**
